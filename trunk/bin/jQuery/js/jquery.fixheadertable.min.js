            ...
            function objectToTable(objectArray,table){
                ...
                if(options.zebra){
                     $('tbody',table).each(function() {
                            if(i%2){
                                $("tr", this).addClass(options.zebraClass);
                            }
...
//                    }
                ...
                if(options.resizeCol&&(options.colratio.length==nbcol)){
                    ...
                    function dragStart(i,x){
                        _resizeInfo={
                            id:i,
                            startX:x.clientX,
                            initTableWidth:getColratioWidth(),
                            offset:getOffset(i)
                        };
            
                        _resizeGhost.css({
                            display:'block',
                            height:_headerscontainer.height()+_body.height()+2+'px',
                            left:_resizeInfo.offset+'px',
                            cursor:'col-resize'
                        });
                    }
                    function dragMove(x){
                        ...
                        if(_resizeInfo.newWidth>parseInt(options.minColWidth)){
                            _resizeGhost.css({
                                left:_resizeInfo.offset+diff+'px'
                            });
                        }else{
                    ...
                    function dragEnd(){
                        $(_colgroup.children()[_resizeInfo.id]).css({
                            width:_resizeInfo.newWidth+'px'
                        });
                        $(_colgroup_body.children()[_resizeInfo.id]).css({
                            width:_resizeInfo.newWidth+'px'
                        });
            ...
            function hideTable(main_wrapper_child,caption,_pager){
                if(options.startHide){
            ...
            hideTable(main_wrapper_child,caption,_pager);
        });
    };
